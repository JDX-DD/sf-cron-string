...
export default class CronBuilderComponent extends LightningElement {
    ...
    yearUnitType = 'Year';
    yearUnitRage = [];
    yearSelectionTypes = [SELECTION_TYPE.ALL, SELECTION_TYPE.RANGE, SELECTION_TYPE.LIST, SELECTION_TYPE.INCREMENT];
    

    monthUnitType = 'Month';
    monthUnitRange = ['JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC'];
    monthSelectionTypes = [SELECTION_TYPE.ALL, SELECTION_TYPE.RANGE, SELECTION_TYPE.LIST, SELECTION_TYPE.INCREMENT];

    weekDayUnitType = 'Week Day';
    weekDayUnitRange = ['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT'];
    weekDaySelectionTypes = [SELECTION_TYPE.ALL, SELECTION_TYPE.RANGE, SELECTION_TYPE.LIST, SELECTION_TYPE.INCREMENT, SELECTION_TYPE.LAST, SELECTION_TYPE.NTH];    
    showWeekDay = false;

    dayUnitType = 'Day';
    dayUnitRange = [];
    daySelectionTypes = [SELECTION_TYPE.ALL, SELECTION_TYPE.RANGE, SELECTION_TYPE.LIST, SELECTION_TYPE.INCREMENT, SELECTION_TYPE.LAST, SELECTION_TYPE.NEAREST];
    showMonthDay = false;
    
    hourUnitType = 'Hour';
    hourUnitRange = [];
    hourSelectionTypes = [SELECTION_TYPE.ALL, SELECTION_TYPE.RANGE, SELECTION_TYPE.LIST, SELECTION_TYPE.INCREMENT];
