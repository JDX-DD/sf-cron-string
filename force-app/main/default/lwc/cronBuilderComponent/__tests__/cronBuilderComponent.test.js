...
describe('c-cron-builder-component', () => {
    ...
    it('The component should render the correct initial state of the Cron String.', () => {
        ...
        // Assert
        const cronString = element.shadowRoot.querySelector('.strong-border').textContent;
    ...
    it('The component should update the Cron String when a year is selected.', () => {
        ...
        const yearSelectionComponent = element.shadowRoot.querySelector('c-cron-selection-component[data-id="year_selection_component"]');
    ...
    it('The component should update the Cron String when a month is selected.', () => {
        ...
        const monthSelectionComponent = element.shadowRoot.querySelector('c-cron-selection-component[data-id="month_selection_component"]');
    ...
    it('The component should update the Cron String when a week day is selected.', () => {
        ...
        const dayTypePicklist = element.shadowRoot.querySelector('lightning-combobox[data-id="day_type_selection"]');
        ...
        return Promise.resolve().then(() => {
            const weekDaySelectionComponent = element.shadowRoot.querySelector('c-cron-selection-component[data-id="weekday_selection_component"]');
    ...
    it('The component should update the Cron String when a day is selected.', () => {
        ...
        dayTypePicklist.dispatchEvent(dayTypeChangeEvent);
        return Promise.resolve().then(() => {
            const daySelectionComponent = element.shadowRoot.querySelector('c-cron-selection-component[data-id="day_selection_component"]');
    ...
    it('The component should update the Cron String when an hour is selected.', () => {
        ...
        const hourSelectionComponent = element.shadowRoot.querySelector('c-cron-selection-component[data-id="hour_selection_component"]');
    ...
    it('The component should update the Cron String when a minute is selected.', () => {
        ...
        const minuteSelectionComponent = element.shadowRoot.querySelector('lightning-combobox[data-id="minute_selection"]');
    ...
    it('The component should update the Cron String when a second is selected.', () => {
        ...
        const secondSelectionComponent = element.shadowRoot.querySelector('lightning-combobox[data-id="second_selection"]');
